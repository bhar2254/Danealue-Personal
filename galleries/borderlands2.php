				...
				<div id="thumbs" class="navigation">
					...
					<ul class="thumbs noscript">
					  <?php
						...
						$imgcoll = array("2015-03-25_00001.jpg",
						...
						foreach($imgcoll as $img)
						{
							...
							?><!--Photo-->
							<li>
								<a class="thumb" href="/gallery/img/<?= $defFolder; ?>/<?= $img; ?>">
									<img src="/gallery/img/<?= $defFolder; ?>/thumbs/<?= $img; ?>" alt="<?= $_GET["title"]?>"/>
								</a>
								<div class="caption">
