...
$pageInfo = array();	
	...
	$pageInfo[postTitle]="Borderlands 2";
    $pageInfo[shortTitle]="Borderlands-2";
    $pageInfo[postAuthor]="Blaine";
    
    $pageInfo[postDate]="28 April 2014";
    $pageInfo[year]="2015";
    $pageInfo[month]="4";
    
    $pageInfo[postTeaser]="Borderlands 2, released in 18 September 2012 (2 years ago from today) was a well-recieved 
	...
	$pageInfo[postText]="Though I personally haven't completed the game due to lack of accompaniment 
