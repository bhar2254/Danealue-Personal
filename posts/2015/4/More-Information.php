...
$pageInfo = array();	
	...
	$pageInfo[postTitle]="More Information";
    $pageInfo[shortTitle]="More-Information";
    $pageInfo[postAuthor]="Blaine";
    
    $pageInfo[postDate]="23 April 2014";
    $pageInfo[year]="2015";
    $pageInfo[month]="4";
    
    $pageInfo[postTeaser]="As the work gets done I add more and more information to the sites. 
	...
	$pageInfo[postText]="Well, after all of this work I've finally added links to runnable 
