...
$pageInfo = array();	
	...
	$pageInfo[postTitle]="Mikecraft";
    $pageInfo[shortTitle]="Mikecraft";
    $pageInfo[postAuthor]="Blaine";
    
    $pageInfo[postDate]="27 April 2014";
    $pageInfo[year]="2015";
    $pageInfo[month]="4";
    
    $pageInfo[postTeaser]="Mikecraft has been a running project for the past year or so. Though, 
	...
	$pageInfo[postText]="If you're interested in the way the game works you can check me out on 
